 ...
 */
    ...
    var expRegTxtApellido=/^[A-Z~-�]{1}[~-�\s\w\.\'-]{1,}$/i;
        ...
        function estiloCORRECTO(inputElement, imagen){
            ...
            if (imagen == undefined)
            {   inputElement.nextSibling.src="tick_ok_sign_4190.jpg"; 
                inputElement.nextSibling.style.visibility = 'visible';
            }
            else { 
                imagen.src="tick_ok_sign_4190.jpg"; 
        ...
        function estiloINCORRECTO(inputElement, imagen){
            ...
            if (imagen == undefined)
            {
                inputElement.nextSibling.src="wrong.png"; 
                inputElement.nextSibling.style.visibility = 'visible';
            }
            else {
                imagen.src="wrong.png";      
                imagen.style.visibility = 'visible';
            }
        }
        ...
        function ActivaImagenValidacion(inputElement, validacion){
            ...
            { 
                ...
                if (validacion == true)
                    inputElement.src="tick_ok_sign_4190.jpg";          
                else 
                    inputElement.src="wrong.png";
            }
            else {
